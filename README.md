Gogs [![Build Status](https://travis-ci.org/nameisalreadytakenexception/gogs.svg?branch=master)](https://travis-ci.org/nameisalreadytakenexception/gogs) [![Build status](https://ci.appveyor.com/api/projects/status/b9uu5ejl933e2wlt/branch/master?svg=true)](https://ci.appveyor.com/project/Unknwon/gogs/branch/master) [![Crowdin](https://d322cqt584bo4o.cloudfront.net/gogs/localized.svg)](https://crowdin.com/project/gogs) [![Discord](https://img.shields.io/discord/382595433060499458.svg)](https://discord.gg/9aqdHU7)
=====================

![](https://github.com/nameisalreadytakenexception/gogs/blob/master/public/img/gogs-large-resize.png?raw=true)

##### Current tip version: [`.VERSION`](templates/.VERSION) (see [Releases](https://github.com/nameisalreadytakenexception/gogs/releases) for binary versions)
...
1. **YOU MUST READ [Contributing Code](https://github.com/nameisalreadytakenexception/gogs/wiki/Contributing-Code) BEFORE STARTING TO WORK ON A PULL REQUEST**.
...
- Want to try it before doing anything else? Do it [online](https://try.gogs.io/nameisalreadytakenexception/gogs)!
...
- [Ship with Docker](https://github.com/nameisalreadytakenexception/gogs/tree/master/docker)
...
- See [contributors page](https://github.com/nameisalreadytakenexception/gogs/graphs/contributors) for top 100 contributors.
- See [TRANSLATORS](conf/locale/TRANSLATORS) for public list of translators.

## License

This project is under the MIT License. See the [LICENSE](https://github.com/nameisalreadytakenexception/gogs/blob/master/LICENSE) file for the full license text.
