Gogs [![Build Status](https://travis-ci.org/nameisalreadytakenexception/gogs.svg?branch=master)](https://travis-ci.org/nameisalreadytakenexception/gogs) [![Build status](https://ci.appveyor.com/api/projects/status/b9uu5ejl933e2wlt/branch/master?svg=true)](https://ci.appveyor.com/project/Unknwon/gogs/branch/master)
=====================
...
- 想要先睹为快？直接去 [在线体验](https://try.gogs.io/nameisalreadytakenexception/gogs) 。
...
- [采用 Docker 部署](https://github.com/nameisalreadytakenexception/gogs/tree/master/docker)
...
- 您可以通过查看 [贡献者页面](https://github.com/nameisalreadytakenexception/gogs/graphs/contributors) 获取 TOP 100 的贡献者列表。
- 您可以通过查看 [TRANSLATORS](conf/locale/TRANSLATORS) 文件获取公开的翻译人员列表。

## 授权许可

本项目采用 MIT 开源授权许可证，完整的授权说明已放置在 [LICENSE](https://github.com/nameisalreadytakenexception/gogs/blob/master/LICENSE) 文件中。
