...
var (
	...
	// e.g. https://try.gogs.io/nameisalreadytakenexception/gogs/commit/d8a994ef243349f321568f9e36d5c3f444b99cae#diff-2
	CommitPattern = regexp.MustCompile(`(\s|^)https?.*commit/[0-9a-zA-Z]+(#+[0-9a-zA-Z-]*)?`)

	// IssueFullPattern matches link to an issue with or without trailing hash,
	// e.g. https://try.gogs.io/nameisalreadytakenexception/gogs/issues/4#issue-685
	...
	// e.g. nameisalreadytakenexception/gogs#12345
