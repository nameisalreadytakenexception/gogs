...
import (
	...
	"github.com/nameisalreadytakenexception/gogs/pkg/process"
	"github.com/nameisalreadytakenexception/gogs/pkg/user"
)
...
func getOpenSSHVersion() string {
	...
	// Trim unused information: https://github.com/nameisalreadytakenexception/gogs/issues/4507#issuecomment-305150441
...
func NewContext() {
	...
	// Windows server and OpenSSH version lower than 5.1 (https://github.com/nameisalreadytakenexception/gogs/issues/4507)
